class FeedController < ApplicationController
  # cache_sweeper :feed_sweeper, :only => [:create]
  ...
  def create
  	@feed_url = FeedUrl.create(:feed_url => params[:feed_url][:feed_url])
  	@feed_entry = FeedEntry.update_from_feed(params[:feed_url][:feed_url],@feed_url.id)
    expire_action
